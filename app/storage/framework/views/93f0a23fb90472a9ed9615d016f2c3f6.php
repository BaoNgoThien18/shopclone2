            ...
            -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ol class="row">
                                ...
                                <?php $__currentLoopData = $product->topProduct(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                                <li class="col-lg-4">
                                    <img src="<?php echo e($row['preview']); ?>" alt="">
                                    <a href="javascript:void(0);" type="button">
                                        <b><?php echo e($row['name']); ?></b> -
                                        <b style="color: red;"><?php echo e(number_format($row['cost'])); ?>đ</b></a>
                                </li>
                    ...
                    <div>
                        ...
                        <div>
                            <ul class="nav nav-pills mb-1 nav-fill" id="pills-tab-1" role="tablist">
                                ...
                                <li class="nav-item category " data-category-id="<?php echo e($row['id']); ?>">
                                    <a class="nav-link" id="pills-home-tab-fill" data-toggle="pill" href="#pills-home-fill" role="tab" aria-controls="pills-home" aria-selected="true"><img src="<?php echo e($row['image']); ?>" width="25px" /><?php echo e($row['name']); ?></a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="modal fade" id="modalBuy" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <div class="modal-content" style="background-image:url('<?php echo e(asset('template/resources/images/bg-buy.png')); ?>');">
                    ...
                    <div class="card-body p-0" style="height:500px;overflow-x:hidden;overflow-y:auto;">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                <tbody>
                                    <?php $__currentLoopData = $historyOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <tr>

                                        <td style="height:20px;">
                                            <lord-icon src="https://cdn.lordicon.com/cllunfud.json" trigger="hover" style="width:30px;height:30px">
                                            </lord-icon> <b style="color: green;">***<?php echo e(substr($row['buyer'], -3, 3)); ?></b> Mua <b style="color: red;"><?php echo e($row['amount']); ?></b>
                                            <b><?php echo e(\App\Models\Product::find($row->product_id)->name); ?></b> - <b style="color:blue;"><?php echo e(number_format($row['pay'])); ?>đ</b>
                                        </td>
                                        <td><span class="badge badge-primary"><?php echo e($row['created_at']->diffForHumans()); ?></span>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$(".category").on("click", function() {
    ...
    $.ajax({
        url: "<?php echo e(url('/ajax/getProductOnCategory')); ?>",
        method: "POST",
        dataType: "JSON",
        data: {
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/shopclone.local/app/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                <div class="tab-pane fade" id="google-reCAPTCHA" role="tabpanel"
                                    ...
                                    <form action="" method="POST">
                                        <textarea name="lienhe" id="lienhe" cols="30" rows="10"><?php echo e($setting::where('name', 'lienhe')->first()['value']); ?></textarea>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/shopclone.local/app/resources/views/backend/pages/setting.blade.php ENDPATH**/ ?>
                ...
                <div class="card card-block p-card">
                    <div class="profile-box">
                        <div class="profile-card rounded">
                            <img src="https://mailngonre.site/public/datum/assets/images/user/1.jpg" alt="profile-bg"
                                class="avatar-100 rounded d-block mx-auto img-fluid mb-3">
                            <h3 class="font-600 text-white text-center mb-0">{{ $user['username'] }}</h3>
                            <p class="text-white text-center mb-5">{{ number_format($user['money']) }} đ</p>
                        </div>
                        <div class="pro-content rounded">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <p class="mb-0 eml"><a href="mailto:{{ $user['email'] }}" class="__cf_email__" data-cfemail="c7afa8a9a0b3a2a8b3a2a887a0aaa6aeabe9a4a8aa">{{ $user['email'] }}</a></p>
                            </div>
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-sm-4 col-lg-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body text-center">
                                <h2 class="mb-2 mt-3 text-primary">{{ number_format($user['total_money']) }} đ</h2>
                                <h4>Tổng Tiền Nạp</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body text-center">
                                <h2 class="mb-2 mt-3 text-success">
                                    {{ number_format($user['chitieu']) }} đ</h2>
                                <h4>Số Dư Sử Dụng</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-lg-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body text-center">
                                <h2 class="mb-2 mt-3 text-warning">{{ number_format($user['money']) }} đ</h2>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label fw-bold fs-6">
                                <span class="required">{{ $user['username'] }}</span>
                            </label>
                            <div class="col-lg-8 fv-row">
                                <input type="hidden" id="token" value="c3e3ff30a760ebcad8335c890c2d29fb" />
                                <input type="text" class="form-control" value="ad1" readonly />
                            </div>
                        </div>
                        <div class="form-group row">

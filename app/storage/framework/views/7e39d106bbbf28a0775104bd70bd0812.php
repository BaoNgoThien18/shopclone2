        ...
        <div class="container-fluid">
            <div class="row">
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10" href="<?php echo e(route('product.index')); ?>"
                        ...
                        <form action="<?php echo e(route('product.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <i>Thêm chuyên mục <a href="<?php echo e(route('category.create')); ?>" target="_blank">tại đây</a></i>
                                </div>
                                <div class="form-group">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/shopclone.local/app/resources/views/backend/product/create.blade.php ENDPATH**/ ?>
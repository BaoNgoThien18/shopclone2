...
<!-- MOD BY Toàn Nam | Zalo : 0338309151 -->
<!doctype html>
<html>
...
<head>
    ...
    <title>Đăng Nhập | MailNgonRe.Site - Hệ Thống Bán Mail Cổ & Acc Facebook Giá Rẻ Chất Lượng Hàng Đầu Việt Nam</title>
   
    <link rel="shortcut icon" href="../assets/storage/images/favicon_0MU.png" />
    ...
    <!-- sweetalert2-->
    <link class="main-stylesheet" href="../public/sweetalert2/default.css" rel="stylesheet"
        type="text/css">
    ...
    #loading-center {
        background: url(../assets/storage/images/gif_loaderYVU.png) no-repeat scroll 50%;
        background-size: 20%;
        width: 100%;
        height: 100%;
        position: relative;
...
<!-- Dev By CMSNT.CO | FB.COM/CMSNT.CO | ZALO.ME/0947838128 | MMO Solution --><style>
    .bg-image {
    background-position: 0 50%;
    background-size: cover;
}
</style>
<body class="bg-image" style="background-image: url(../assets/storage/images/bg_login0XZ.png);">
    <!-- loader Start -->
    <div id="loading">
                ...
                <div class="row align-items-center justify-content-center h-100">
                    <div class="col-md-5">
                        <div class="card p-3">
                            <div class="card-body">
                                <div class="auth-logo">
                                    <img src="https://mailngonre.site/assets/storage/images/logo_dark_BCE.png"
                                        class="img-fluid  rounded-normal  darkmode-logo" alt="logo">
                                    <img src="https://mailngonre.site/assets/storage/images/logo_light_3YR.png"
                                ...
                                <form>
                                    ...
                                    <button type="button" id="btnRegister"
                                        class="btn btn-primary btn-block mt-2">Đăng Ký</button>
                                    <div class="col-lg-12 mt-3">
                                        <p class="mb-0 text-center">Bạn đã có tài khoản? <a
                                                href="./Login.html">Đăng Nhập</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>

...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('template/assets/storage/images/favicon_0MU.png')); ?> " />
    <link rel="stylesheet" href="<?php echo e(asset('template/public/datum/assets/css/backend-plugin.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('template/resources/css/responsive.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/resources/css/backend.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/resources/css/customize.css')); ?>">
    <script src="<?php echo e(asset('template/resources/js/jquery.js')); ?> "></script>

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-9usAa10IRO0HhonpyAIVpjrylPvoDwiPUiKdWk5t3PyolY1cOd4DSE0Ga+ri4AuTroPR5aQvXU9xC6qOPnzFeg==" crossorigin="anonymous" referrerpolicy="no-referrer"
    />
    <!-- sweetalert2-->
    <link class="main-stylesheet" href="<?php echo e(asset('template/public/sweetalert2/default.css')); ?>" rel="stylesheet" type="text/css">
    <script src="<?php echo e(asset('template/public/sweetalert2/sweetalert2.js')); ?> "></script>
    <!-- Cute Alert -->
    <link class="main-stylesheet" href="<?php echo e(asset('template/public/cute-alert/style.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <style>
        ...
        #loading-center {
            ...
            background: url(<?php echo e(asset('template/assets/storage/images/gif_loaderYVU.png')); ?>) no-repeat scroll 50%;
            background-size: 20%;
            width: 100%;
            height: 100%;
            position: relative;
...
<body class="color-light ">
                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                                    ...
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            <li class="dropdown-item-1 list-group-item px-2">
                                                <a class="p-0" href="#" style="color: #8f9fbc;"><img src="<?php echo e(asset('template/assets/storage/flags/flag_Vietnamese.png')); ?>" alt="img-flaf" class="img-fluid mr-2" style="width: 30px;height: 20px;min-width: 15px;" />Vietnamese</a>
                                            </li>
                                            <li class="dropdown-item-1 list-group-item px-2">
                                                <a class="p-0" href="#" style="color: #8f9fbc;"><img src="<?php echo e(asset('template/assets/storage/flags/flag_English.png')); ?>" alt="img-flaf" class="img-fluid mr-2" style="width: 30px;height: 20px;min-width: 15px;" />English</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li class="px-3 pt-3 pb-2 ">
                            <span class="text-uppercase small font-weight-bold">Số Dư <span
                                    style="color: yellow;"><?php echo e(number_format($user['money'])); ?>đ</span></span>
                            </span>
                        </li>
                        <!-- <li class=" sidebar-layout">
                        ...
                        <li class=" sidebar-layout">
                            ...
                            <ul id="menuSanPham" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class=" sidebar-layout ">
                                    <a href="<?php echo e(route('product.show', $row['id'])); ?>" class="svg-icon">
                                        <img width="25px" src="<?php echo e(asset($row['image'])); ?>" class="mr-2"><span class=""><?php echo e($row['name']); ?></span>
                                    </a>
                                </li>
                        ...
                        <li class=" sidebar-layout">
                            <a href="<?php echo e(url('Recharge')); ?>" class="svg-icon ">
        ...
        <div class="iq-top-navbar">
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    ...
                    <b><?php echo e(number_format($user['money'])); ?>đ</b></span>
                        <!--  -->
                    </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                ...
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="<?php echo e(route('admin')); ?>">Trang quản trị</a>
                                </li>
                                <?php endif; ?>
                                <li class="nav-item nav-icon dropdown">
                                    <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <svg style="width: 25px;" class="svg-icon mr-0 text-secondary" id="h-01-p" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <span class="mb-0 ml-2 user-name"><?php echo e($user['username']); ?></span>
    ...
    <script src="<?php echo e(asset('template/public/datum/assets/js/backend-bundle.min.js')); ?> "></script>
    <!-- Chart Custom JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/customizer.js')); ?> "></script>
    <script src="<?php echo e(asset('template/public/datum/assets/js/sidebar.js')); ?> "></script>
    <!-- Flextree Javascript-->
    <script src="<?php echo e(asset('template/public/datum/assets/js/flex-tree.min.js')); ?> "></script>
    <script src="<?php echo e(asset('template/public/datum/assets/js/tree.js')); ?> "></script>
    <!-- Table Treeview JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/table-treeview.js')); ?> "></script>
    <!-- SweetAlert JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/sweetalert.js')); ?> "></script>
    <!-- Vectoe Map JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/vector-map-custom.js')); ?> "></script>
    <!-- Chart Custom JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/chart-custom.js')); ?> "></script>
    <script src="<?php echo e(asset('template/public/datum/assets/js/charts/01.js')); ?> "></script>
    <script src="<?php echo e(asset('template/public/datum/assets/js/charts/02.js')); ?> "></script>
    <!-- slider JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/slider.js')); ?> "></script>
    <!-- Emoji picker -->
    <script src="<?php echo e(asset('template/public/datum/assets/vendor/emoji-picker-element/index.js')); ?> " type="module"></script>
    <!-- app JavaScript -->
    <script src="<?php echo e(asset('template/public/datum/assets/js/app.js')); ?> "></script>
...
<script type="text/javascript">
    ...
    function totalPayment() {
        ...
        $.ajax({
            url: "<?php echo e(url('/ajax/totalPayment')); ?>",
            method: "POST",
            data: {
...
<?php /**PATH /var/www/shopclone.local/app/resources/views/frontend/layouts/master.blade.php ENDPATH**/ ?>